...
var questions = [
  {
    question: "Vishal is interested in which start-ups (Sofware/Hardware) ? ",
    answer: "Software",
  },
  {
    question: " What's Vishal favorite love song ? ",
...
function welcome() {
  var userNameQuestion = readlineSync.question(
    chalk.bold.red(" What's your name, buddy ? ")
  );
...
function showScore() {
  ...
  console.log(
    chalk.underline(
      " Check out other scores, if you have scored like them, please share a SS with vinay to update the scoreboard."
    )
  );
